...
/**
 * Log瀹搞儱鍙块敍宀?娴肩嘲ndroid.util.Log閵嗭拷tag阏奉亜濮╂祸褏鏁挞敍灞剧壐瀵拷
 * customTagPrefix:className.methodName(L:lineNumber),
 * customTagPrefix娑撹櫣铍栭弮璺哄涧鏉堟挸锸敍姝漧assName.methodName(L:lineNumber)閵嗭拷 * <p/>
 * Author: wyouflf Date: 13-7-24 Time: 娑揿宕?2:23
 */
