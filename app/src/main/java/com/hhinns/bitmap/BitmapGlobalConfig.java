...
import com.hhinns.bitmap.core.BitmapCache;
import com.hhinns.bitmap.core.LruDiskCache;
import com.hhinns.bitmap.download.Downloader;
import com.hhinns.bitmap.download.SimpleDownloader;
import com.hhinns.library.CompatibleAsyncTask;
import com.hhinns.library.LogUtils;



/**
 * Author: wyouflf Date: 13-7-31 Time: 涓嫔崃11:15
 */
public class BitmapGlobalConfig
{

	private String diskCachePath;
	public final static int MIN_MEMORY_CACHE_SIZE = 1024 * 1024 * 6; // 6M
	private int memoryCacheSize = 1024 * 1024 * 10; // 4MB
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory()
	{
		...
		{
			Thread thread = new Thread(r, "BitmapUtils #"
	...
	public String getDiskCachePath()
	{
		...
		{
			diskCachePath = BitmapCommonUtils.getDiskCacheDir(mContext,
					"xBitmapCache");
		}
	...
	public ExecutorService getBitmapLoadExecutor()
	{
		if (_dirty_params_bitmapLoadExecutor || bitmapLoadExecutor == null)
		{
			bitmapLoadExecutor = Executors.newFixedThreadPool(
					getThreadPoolSize(), sThreadFactory);
	...
	private class BitmapCacheManagementTask extends
			CompatibleAsyncTask<Object, Void, Object[]>
	{
